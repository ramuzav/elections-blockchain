...
namespace Blockchain
{
    ...
    {
        public static void FromXmlStringInternal(this RSACryptoServiceProvider rsa, string xmlString)
        {
        ...
        public static string ToXmlStringInternal(this RSACryptoServiceProvider rsa, bool includePrivateParameters)
        {
